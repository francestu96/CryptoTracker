package com.example.cryptotracker.formatters;
...
public class CurrencyFormatter {
    ...
    private static CurrencyFormatter sInstance;
    ...
    public static synchronized CurrencyFormatter getInstance(Context context) {

        if (sInstance == null) {
            sInstance = new CurrencyFormatter(context.getApplicationContext());
        }
        return sInstance;
    }
