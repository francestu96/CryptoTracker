...
public class MyDatabaseFactory extends SQLiteOpenHelper {
    ...
    private static MyDatabaseFactory sInstance;
    ...
    public static synchronized MyDatabaseFactory getInstance(Context context) {

        if (sInstance == null) {
            sInstance = new MyDatabaseFactory(context.getApplicationContext());
        }
        return sInstance;
    }

    private MyDatabaseFactory(Context context) {
    ...
    public CoinFavoritesModel getFavorites() {
        ...
        return new CoinFavoritesModel(favoritesList, favoritesMap);
    }
    ...
    public void saveCoinFavorites(CoinFavoritesModel favs) {
